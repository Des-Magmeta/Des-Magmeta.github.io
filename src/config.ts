...
export const siteConfig: SiteConfig = {
	title: "Magmeta's website",
	subtitle: "仲代骆驼字体之地",
	siteURL: "https://des-magmeta.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	themeColor: {
		hue: 80, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/cover.webp",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/cover.webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "Welcome to my space!", // 主页横幅主标题

			subtitle: [
				"字体宅拯救字体！Designer otakus save the font!",
				"字体设计师一定要懂字体！",
				"拒绝巾川华文审美，从你我做起",
				"打破泛中日韩字体「不可能三角」一定要实现！",
				"字因你太美。Fonts are full of diversity with you.",
				"绮丽一声拜拜离开这字体，要靠奏字人士搞搞新意思",
			],
			typewriter: {
	...
	font: {
		...
		asciiFont: {
			...
			fontFamily: "MonaSans",
			fontWeight: "400",
			localFonts: ["MonaSans-Regular.ttf"],
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到我的博客！目前项目正在测试中", // 公告内容
